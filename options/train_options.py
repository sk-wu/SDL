...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--niter', type=int, default=600, help='# of iter at starting learning rate')
        ...
        self.parser.add_argument('--weight_gan', type=float, default=10.0, help='weight for gan loss')
        # self.parser.add_argument('--weight_rec', type=float, default=10.0, help='weight for image-level reconstruction loss')
        self.parser.add_argument('--no_style_loss', type=str, default=True, help='do *not* use style loss (gram)')
        self.parser.add_argument('--no_style_contrastive_loss', type=str, default=True, help='do *not* use style contrastive loss (gram)')
        self.parser.add_argument('--weight_style', type=float, default=10.0, help='weight for style loss (gram)')
        self.parser.add_argument('--weight_style_contrastive', type=float, default=100.0, help='weight for style contrastive loss (gram)')
        self.parser.add_argument('--no_perc_loss', action='store_true', help='if specified, do *not* use perceptual loss')
        ...
        self.parser.add_argument('--no_domain_loss', type=str, default=True, help='do *not* use domain alignment loss')
        self.parser.add_argument('--weight_domain', type=float, default=10.0, help='weight for domain adversarial loss')
        self.parser.add_argument('--feature_mapping_ratio', type=float, default=1.0, help='feature mapping ratio')
        self.parser.add_argument('--weight_rec_sketch', type=float, default=10.0, help='weight for sketch reconstruction')
        self.parser.add_argument('--split_prob', type=float, default=0.0, help='probability for split data aug')
        self.parser.add_argument('--split_prob_1', type=float, default=0.0, help='probability for split data aug 1')
        self.parser.add_argument('--split_prob_2', type=float, default=0.0, help='probability for split data aug 2')
        self.parser.add_argument('--no_contrastive_loss', type=str, default=True, help='do *not* use contrastive loss')
        ...
        self.parser.add_argument('--weight_ct_path', type=float, default=0.5, help='weight for ct path')
